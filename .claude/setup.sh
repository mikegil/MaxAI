...
echo "  1) $HOME/MaxAI (recommended)"
echo "  2) $HOME/Projects/MaxAI"
echo "  3) $HOME/Documents/MaxAI"
echo "  4) Custom location"
echo ""

DEFAULT_DIR="$HOME/Documents/MaxAI"
...
case $choice in
    1)
        ...
        ;;
    2)
        PAI_DIR="$HOME/Projects/MaxAI"
        ;;
    3)
        PAI_DIR="$HOME/Documents/MaxAI"
        ;;
    4)
        PAI_DIR=$(ask_input "Enter custom path" "$HOME/MaxAI")
        ;;
    *)
        PAI_DIR="$DEFAULT_DIR"
        ;;
